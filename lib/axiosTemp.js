...
class AXIOSClient {
    ...
    config(configs) {
        ...
        if (configs)
            ...
            this.configs = {
                ...
                KeepaliveAgent: configs.SDK_KEEPALIVE_AGENT || { keepAlive: true, freeSocketTimeout: 30000 }, maxRedirectDepth: configs.AXIOSClient_MAX_REDIRECT_DEPTH || 20,
            ...
            this.configs = {
              ...
              /*  KeepaliveAgent: this.env.get("SDK_KEEPALIVE_AGENT", {
                ...
                _maxRedirectDepth: this.env.get("AXIOSClient_MAX_REDIRECT_DEPTH", 20),
    ...
    get(returnRequestHeaders = false, returnRawResponse = false, isRedirect = false) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            try {
                ...
                const req = await this.buildReqWithAuth(options);
    ...
    startAPMEvent() {
        ...
        if (this.logAPM && this.checkAPMEnabled()) {
            ...
            this.apm = {
                ...
                componentTypeCode: "JAVASCRIPT", componentName: "AXIOSClient",
            ...
            this.apmLayer = APMLayer("JAX_RS_CLIENT", "AXIOSClient", this._method, [this._url]);
    ...
    buildReqWithAuth(options, data = false) {
            ...
            if (this._authType === SDK_BASIC_AUTH) {
                ...
                const token = this.jwtTokenHandler(this);
